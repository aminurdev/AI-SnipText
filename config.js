...
const CONFIG = {
  ...
  get GEMINI_API_KEY() {
    return (typeof ENV !== 'undefined' && ENV.GEMINI_API_KEY) || 'YOUR_GEMINI_API_KEY_HERE';
  },
  ...
  EXTENSION_SETTINGS: {
    ...
    DEFAULT_PROMPT: 'Extract all text from this image. Return only the text content, no additional formatting or explanations.'
  },
